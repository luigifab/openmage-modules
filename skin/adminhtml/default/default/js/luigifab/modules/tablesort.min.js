/**
 * Table Sorter 2.5 [Apache 2 license]
...
if(cell.className.indexOf('defaultTsort')>-1){/n([0-9])/g.exec(cell.className);arrow.innerHTML=TableSort.arrowUp+'<sup>'+RegExp.$1+'</sup>';
