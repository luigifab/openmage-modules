...
class Luigifab_Modules_Block_Adminhtml_Jobs extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface {
	...
	public function render(Varien_Data_Form_Element_Abstract $element) {
		...
		return '<div class="entry-edit-head"><h4>'.$element->getLegend().' ('.$block->getCount().')</h4></div>'.
			'<div class="luigifab box grid jobs">'.$block->toHtml().'</div>';
	}
}